...
3. **The Cryptographic Tri-Key Lock**: To prevent any single nation or a rogue AI from weaponizing the planetary grid, systemic overrides require consensus from three independent keys:
   - Key 1: A decentralized, rotating human coalition of engineers, ethicists, and community representatives.
